 ...
 * Used by feature badge expansion in PageView and by the markdown export.
 */
...
const featureDocs: Record<string, FeatureDoc> = {
  ...
  scroll: {
    ...
    urls: {
      inertiajs: 'https://inertiajs.com/infinite-scroll',
  ...
  once: {
    ...
    urls: {
      inertiajs: 'https://inertiajs.com/docs/v3/data-props/once-props',
  ...
  'clear-history': {
    description: 'Encryption key rotated when this page loaded — earlier history entries can no longer be restored.',
    urls: {
  ...
  poll: {
    description: 'Periodic reload issued by router.poll().',
    urls: {
      inertiajs: 'https://inertiajs.com/polling',
      'inertia-rails': 'https://inertia-rails.dev/guide/polling',
    },
  },
  flash: {
